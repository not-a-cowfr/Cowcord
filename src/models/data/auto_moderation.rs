...
pub struct AutomodAlert {
	...
	pub decision_outcome:             String, // https://docs.discord.sex/resources/auto-moderation#automod-decision-outcome
	pub channel_id:                   Snowflake,
	pub flagged_message_id:           Snowflake,
	pub keyword:                      String,
	pub keyword_matched_content:      String,
	pub block_profile_update_type:    String, // https://docs.discord.sex/resources/auto-moderation#automod-profile-update-type
	pub quarantine_user:              String, // https://docs.discord.sex/resources/auto-moderation#automod-quarantine-user-reason
	pub quarantine_user_action:       String, // https://docs.discord.sex/resources/auto-moderation#automod-quarantine-user-action
	pub quarantine_event:             String, // https://docs.discord.sex/resources/auto-moderation#automod-quarantine-event-type
	pub voice_channel_status_outcome: String, // https://docs.discord.sex/resources/auto-moderation#automod-decision-outcome
	pub application_name:             String,
	pub interaction_user_id:          Snowflake,
	pub interaction_callback_type:    String, // https://docs.discord.sex/resources/auto-moderation#automod-interaction-callback-type
...
pub struct AutomodIncidentNotificationEmbed {
	pub notification_type:                 String, // https://docs.discord.sex/resources/auto-moderation#automod-incident-notification-type
	pub decision_id:                       String,
	pub action_by_user_id:                 Snowflake,
	pub raid_type:                         String, // https://docs.discord.sex/resources/auto-moderation#automod-raid-type
	pub raid_datetime:                     Timestamp,
	pub join_attempts:                     u32,
	pub dms_sent:                          u32,
	pub suspicious_mention_activity_until: Timestamp,
	pub resolved_reason:                   String, // https://docs.discord.sex/resources/auto-moderation#automod-raid-resolution-reason
}
...
pub struct AutomodRules {
	...
	pub event_type:       u8, // https://docs.discord.sex/resources/auto-moderation#automod-event-type
	pub trigger_type:     u8, // https://docs.discord.sex/resources/auto-moderation#automod-trigger-type
...
pub struct AutomodTriggerMetadata {
	...
	pub presets:                         Vec<u8>, // https://docs.discord.sex/resources/auto-moderation#automod-keyword-preset-type
...
pub struct AutomodAction {
	pub r#type:   u8, // https://docs.discord.sex/resources/auto-moderation#automod-action-type
